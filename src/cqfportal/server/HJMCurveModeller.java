...
public class HJMCurveModeller {	
	private Random rand = new Random(System.nanoTime());
	
	private static Logger logger = 
			Logger.getLogger(HJMCurveModeller.class.getName()); 
		
	public YieldCurveSet getCurveSet(HJMFactorData calib, HJMVolatilities vols, double maturity) {
