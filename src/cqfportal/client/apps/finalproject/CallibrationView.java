...
//		
		fp.add(
				new HTML("<br><b>Term Structure of Day 0 Interest Rates<b>"));
...
//		fp.addStyleName("leftPaddedPanel");
	...
	private FlowPanel getVolPrincipalComponentFlowPanel() {
		...
		FlowPanel fp = new FlowPanel();
		fp.add(
				new HTML("<br><b>Volatility Principal Components (T refers to time to maturity)<b>"));
		
		//first component
		Label l1 = new Label("First principal component (Vol_1)");
		l1.addStyleName("labelCustom");
		fp.add(l1);
		...
		//second component
		Label l2 = new Label("Second principal component (Vol_2)");
		l2.addStyleName("labelCustom");
		fp.add(l2);	
		...
		//third component
		Label l3 = new Label("Third principal component (Vol_3)");
		l3.addStyleName("labelCustom");
		fp.add(l3);	
		p = new HorizontalPanel();
